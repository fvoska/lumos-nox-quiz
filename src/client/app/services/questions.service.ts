...
export class QuestionsService {
  ...
  public getSlidesQuestions(numQuestions: number = 30, numCategories: number = 6): Observable<Array<Question>> {
    return this.http.get('assets/questions.slides.json').map((res: Response) => res.json().questions);
  }
}
